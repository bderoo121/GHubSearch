...
/**
 * This class represents an Android string-resource and its possible arguments. I like to use this
 * class in all of my projects to make testing text changes easier.
 */
